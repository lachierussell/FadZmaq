...
SELECT *
FROM matching_algorithm('TMnFU6BmQoV8kSMoYYGLJDu8qSy1');-- this script is for creating a new test database as well as a user with privileges for that test db
...
SELECT *
FROM matching_algorithm('TMnFU6BmQoV8kSMoYYGLJDu8qSy1');DROP ROLE IF EXISTS test_fadzmaq_app;
